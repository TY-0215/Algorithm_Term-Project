...
#include "printBFS.h"
#include "printPrim.h"
#include "printKruskal.h"
#include "printTopologicalSort.h"
#include "printSST.h"
#include "printAS.h"
#include "printBT.h"
#include "printBB.h"
...
void graphPtr(void);
void graphMenu(void);
void statetreePtr(void);
void statetreeMenu(void);
...
void mainPtr(void) {
	...
	puts("■                                                                                                      ■");
	printf("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
	gotoxy(17, 13); printf("[정렬 알고리즘]");
	gotoxy(37, 13); printf("[그래프 알고리즘]");
	gotoxy(59, 13); printf("[상태 공간 트리]");
	gotoxy(80, 13); printf("[종료하기]");
	return;
}
...
void mainMenu(void) {
	...
	else if (POS == 2) { statetreeMenu(); cls; }
	else if (POS == 3) {
		return;
	}
}
...
void statetreePtr(void) {
	...
	puts("■                                                                                                      ■");
	printf("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
	gotoxy(30, 5); printf("◈ 상태 공간 트리");
	gotoxy(65, 5); printf("◈ A* 알고리즘");
	gotoxy(30, 8); printf("◈ 백트랙킹 알고리즘");
	gotoxy(65, 8); printf("◈ 한정분기 알고리즘");
	gotoxy(30, 11); printf("◈ 뒤로가기");
	gotoxy(65, 11); printf("◈ 종료하기");
